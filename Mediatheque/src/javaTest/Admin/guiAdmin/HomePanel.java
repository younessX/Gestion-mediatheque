...
public class HomePanel extends JPanel{
 public HomePanel(){
  ...
  InfoPanel panel1 = new InfoPanel(new TotalClass("Total Document", "100",
          new ImageIcon("images\\document.png"), new Color(0x2296F4),"SommeDocument"));

  InfoPanel panel2 = new InfoPanel(new TotalClass("Total lecteurs", "40",
          new ImageIcon("images\\reading.png"), new Color(0x4DB151),"SommeLecture"));

  InfoPanel panel3 = new InfoPanel(new TotalClass("Documents empruntes", "30",
          new ImageIcon("images\\emprunt.png"), new Color(0x725FEC),"SommeEmprunt"));

  InfoPanel panel4 = new InfoPanel(new TotalClass("Documents rendus", "10",
          new ImageIcon("images\\rendu.png"), new Color(0x3B5A93),"SommeDisponible"));
  ...
  JLabel label = new JLabel("Dernieres Documents Ajouter");
